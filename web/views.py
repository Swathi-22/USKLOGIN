...
def generatePoster(request):
    ...
    context = {"is_poster": True, "common_services_poster": common_services_poster, "festivel_poster": festivel_poster, "professional_poster": professional_poster}
    return render(request, "web/generate-poster.html", context)


def generateBill(request):
    services = Services.objects.all()
    context = {"is_bill": True, "services": services}
...
def generateForms(request):
    ...
    context = {"is_form": True, "generate_forms": generate_forms}
...
def backOfficeServices(request):
    ...
    context = {"is_backservice": True, "back_office_services": back_office_services}
    return render(request, "web/back-office-services.html", context)


def bonus(request):
    agent_bonus = AgentBonus.objects.all()
    context = {"is_bonus": True, "agent_bonus": agent_bonus}
...
def F_A_Q(request):
    ...
    context = {"Frequently_Asked_Questions": Frequently_Asked_Questions}
